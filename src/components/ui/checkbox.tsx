...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      "peer h-6 w-6 shrink-0 rounded-full border-2 border-muted-foreground/30 ring-offset-background transition-all duration-200",
      ...
      "hover:border-accent/60 hover:scale-105",
      className
    )}
    {...props}
  >
